export function checkIfContainsCharacters(
...
export function applyStyleToInput(
...
export function checkFullAddressValidity(element: HTMLElement) {
  ...
  if (
    billingAddress.validity.valid &&
    billingIndex.validity.valid &&
    billingCity.validity.valid
  ) {
